...
var coins_json_1 = require("../data/coins.json");
var COINS_WHITE_LIST = [
    'BTC', 'ETH',
    'SOL', 'BNB', 'XRP',
    'ADA', 'DOGE',
    'TRX', 'DOT',
...
exports.coinAPI = {
    getList: function () {
        var resultList = [];
        for (var _i = 0, coinsData_1 = coins_json_1.default; _i < coinsData_1.length; _i++) {
            var coinData = coinsData_1[_i];
    ...
    requestData: function (id, date) {
        return __awaiter(this, void 0, void 0, function () {
            var data, url, request, response, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data = {};
                        url = "https://api.coingecko.com/api/v3/coins/".concat(id, "/history?date=").concat(date);
                        request = fetch(url);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, , 5]);
